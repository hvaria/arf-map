  ...
  return (
    <div className="h-screen w-screen flex overflow-hidden bg-background" data-testid="map-page">
      ...
      <aside className="hidden md:flex flex-col w-80 shrink-0 border-l bg-background z-10">
        {/* Sidebar header */}
        <div className="px-4 py-3 shrink-0 flex items-center justify-between gap-2" style={{ borderBottom: "1px solid var(--brand-border)" }}>
          <div className="flex items-center" style={{ gap: "10px" }}>
            {/* Circle of Care logo */}
            <svg viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" style={{ height: "44px", width: "auto", flexShrink: 0 }}>
            ...
            {/* Brand name stack */}
            <div style={{ display: "flex", flexDirection: "column", lineHeight: 1, fontFamily: "'Nunito', sans-serif" }}>
              <span style={{ fontSize: "7px", fontWeight: 600, letterSpacing: "2.5px", color: "var(--brand-primary)", textTransform: "uppercase" }}>NEIGHBOURHOOD</span>
              <span style={{ fontSize: "20px", fontWeight: 900, color: "var(--brand-primary-dark)", lineHeight: 1.1 }}>Care</span>
              <span style={{ fontSize: "7px", fontWeight: 600, letterSpacing: "2.5px", color: "var(--brand-primary)", textTransform: "uppercase" }}>FINDER</span>
            </div>
          </div>
